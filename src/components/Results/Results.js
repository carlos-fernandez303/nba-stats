  ...
  return (
    <>
      {headshot ? (
            ...
            <>
              ...
              <Row className="player-background">
                ...
                >
                  ...
                  <Row className="background-value">
                    {getBirthday(
                      headshot.dateOfBirthUTC.split("-").join(" ")
                    )[1] +
                      " " +
                      getBirthday(
                        headshot.dateOfBirthUTC.split("-").join(" ")
        ...
        <div className="no-player">Player stats not found.</div>
      )}
    </>
  );
}
